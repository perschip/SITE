            ...
            <div class="row">
                <div class="col-md-8">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" class="form-control" id="slug" name="slug" value="<?php echo htmlspecialchars($slug); ?>">
                        <div class="form-text">Leave empty to generate from title. The slug will be used in the URL: /page.php?slug=your-slug</div>
                    </div>
                ...
                <div class="col-md-4">
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <button type="submit" class="btn btn-primary w-100">Publish Page</button>
                        </div>
                    </div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            ...
                            <div id="image-preview-container" class="mt-2 d-none">
                                <img id="featured-image-preview" src="" alt="Featured Image Preview" class="img-fluid">
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card mb-3">
                        ...
                        <div class="card-body">
                            <div class="mb-3">
                                ...
                                <div class="form-text">If left empty, an excerpt will be generated automatically. Recommended length: 150-160 characters.</div>
                            </div>
                        </div>
                    </div>
                </div>
